...
import com.driver_hiring.driver.LoginActivity;
...
public class NotificationService extends Service {
    ...
    private String content, title, did = "";

    private Timer timer, mLocationTimer;
    private TimerTask timerTask, mLocationTask;
...
//        notificationIntent.putExtra(LoginActivity.c, content);
