...
public class UserModel {
    ...
    String UserID, Name, Contact, Photo, CarModel, CarNo, currentLocation, PeekCost, NorCost, rating, distance,tripId;

    public UserModel(String driverId, String name, String contact, String photo
